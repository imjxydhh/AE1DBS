...
try{
	...
	$sqlRoom = 'SELECT RoomID FROM BookInfo WHERE ((startDate BETWEEN :startDate AND :endDate)';
	$sqlRoom = $sqlRoom . ' OR (endDate BETWEEN :startDate AND :endDate)';
	$sqlRoom = $sqlRoom . ' OR (:startDate BETWEEN startDate AND endDate)';
	$sqlRoom = $sqlRoom . ' OR (:endDate BETWEEN startDate AND endDate))';
	$sqlRoom = $sqlRoom . ' AND RoomID = :roomID AND Stairs = :stairs AND endDate <> :startDate AND :endDate <> startDate;';
	...
	$tmpRoom->bindParam(':stairs', $_POST['floor']);
